...
[travis-badge]: https://travis-ci.org/filipesilva/angular-ng-sidebarjs.svg?branch=master
[travis-badge-url]: https://travis-ci.org/filipesilva/angular-ng-sidebarjs
...
1. Create a project folder (you can call it `ng-sidebarjs` and rename it later).
...
```
git clone https://github.com/filipesilva/angular-ng-sidebarjs.git
cd angular-ng-sidebarjs
npm install
npm start
```
...
### Download
[Download the QuickStart Library seed](https://github.com/filipesilva/angular-ng-sidebarjs/archive/master.zip)
...
Use your editor to search the project for all instances of `angular-ng-sidebarjs` and change it
